...
2. Show the verified DEIMv2 + ByteTrack overlay clip in Camera 1.
3. Keep the clean full source separately for runtime evidence extraction.
4. Render Camera 1 video with `object-contain` in the grid and modal.
5. Verify frontend tests and production build.
6. In mock demo mode, emit the Phase7C abandoned event at 13.75 s in the overlay clip.
