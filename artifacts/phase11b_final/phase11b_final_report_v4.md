...
- Provenance: `artifacts\phase11b_final\production-roi-run-v3.json` validates clip completion, ROI, prediction hash, event-rule hash, and inference-script hash.
